...
public class Join implements org.apache.thrift.TBase<Join, Join._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new JoinStandardSchemeFactory());
    schemes.put(TupleScheme.class, new JoinTupleSchemeFactory());
  }
  ...
  private static class JoinStandardScheme extends StandardScheme<Join> {
  ...
  private static class JoinTupleScheme extends TupleScheme<Join> {
